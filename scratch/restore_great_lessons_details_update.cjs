...
const targetMarkerStart = '// --- ONE-TIME GREAT LESSONS DETAILS UPDATE ---';
...
console.log("Successfully removed the Great Lessons details update hook from CurriculumManager.jsx!");
