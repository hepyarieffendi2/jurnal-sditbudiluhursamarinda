...
// 1. Define 53 existing levels metadata
const existingLevelsMetadata = {
  // lang_spoken
...
// 2. Define 21 new levels data to append
const newLevelsMap = {
  "lang_spoken": [
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Moderator Gavel", "Topic Cards", "Timer"],
    ...
    },
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Podium", "Microphone", "Speech Draft"],
  ...
  "lang_word_study": [
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Etymology Cards", "Dictionary"],
    ...
    },
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Terminology Cards", "Dictionary"],
  ...
  "lang_eng_word_study": [
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Prefix Cards", "Base Word Cards", "Suffix Cards"],
    ...
    },
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Homophone Cards", "Sorting Mats"],
    ...
    },
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Root Word Trees", "Meaning Labels"],
  ...
  "lang_grammar": [
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Grammar Symbols", "Classification Cards"],
    ...
    },
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Sentence Strips", "Conjunction Pins"],
  ...
  "lang_analysis": [
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Logical Analysis Chart", "Sentence Strips"],
    ...
    },
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Diagramming Board", "Drawing Tools"],
  ...
  "lang_write": [
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Essay Outline", "Graphic Organizers"],
    ...
    },
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Notebook", "Writing Guides"],
  ...
  "lang_eng_write": [
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Paragraph Graphic Organizer", "Narrative Planner"],
    ...
    },
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Writing Templates", "Sample E-mails"],
    ...
    },
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Research Cards", "Poster Boards"],
  ...
  "lang_literature": [
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Children's Novels", "Folklore Cards"],
    ...
    },
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Book Review Templates", "Sample Reviews"],
  ...
  "lang_eng_literature": [
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Fable Books", "Moral Cards"],
    ...
    },
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Poetry Anthology", "Acrostic Worksheets"],
    ...
    },
    {
      ...
      "presentation": {
        ...
        "toolsList": ["Chapter Books", "Analysis Charts"],
...
// 3. Assemble the file code template
const generatedCode = `const fs = require('fs');
const path = require('path');

const targetFile = path.join(__dirname, '../src/pages/CurriculumManager.jsx');
const content = fs.readFileSync(targetFile, 'utf8');

const existingMetadata = ${JSON.stringify(existingLevelsMetadata, null, 2)};
...
fs.writeFileSync(path.join(__dirname, 'inject_bahasa_migration.cjs'), generatedCode, 'utf8');
console.log("Successfully generated scratch/inject_bahasa_migration.cjs!");
