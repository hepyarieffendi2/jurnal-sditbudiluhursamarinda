...
const targetMarkerStart = '// --- ONE-TIME GREAT LESSONS GRADES FIX ---';
...
console.log("Successfully removed the Great Lessons grades fix hook from CurriculumManager.jsx!");
