...
const targetMarkerStart = '// --- ONE-TIME STAMP GAME UPDATE MIGRATION ---';
...
// Replace with empty string (or clean spacing) to remove it completely
const newContent = content.replace(originalSlice, '');

fs.writeFileSync(targetFile, newContent, 'utf8');
console.log("Successfully removed the Stamp Game migration hook from CurriculumManager.jsx!");
